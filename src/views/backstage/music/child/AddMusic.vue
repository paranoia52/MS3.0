<template>
  <div class="addmusic">
    <el-dialog title="上传曲目" :show-close="false" :visible="visible">
      <el-form :model="form" size="small" ref="ruleForm" :rules="rules">
        ...
        <el-form-item label="封面" label-width="100px" prop="Cover">
          ...
          <el-upload class="avatar-demo" action="http://127.0.0.1:3000/upload" :show-file-list="false"
        ...
        <el-form-item label="上传歌曲" label-width="100px" prop="MusicUrl">
          <el-upload class="avatar-demo" action="http://127.0.0.1:3000/upload" :show-file-list="false"
            ...
            <el-button size="small" type="primary">点击上传</el-button>
            <template #tip class="el-upload__tip">只能上传音频文件，且不超过50M</template>
          </el-upload>
        </el-form-item>
